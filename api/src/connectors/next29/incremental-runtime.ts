...
function normalizeResources(input: readonly Next29RuntimeResource[] | undefined): Next29RuntimeResource[] { const source: readonly Next29RuntimeResource[] = input?.length ? input : ["orders", "subscriptions", "disputes"]; return Array.from(new Set<Next29RuntimeResource>(source)); }
