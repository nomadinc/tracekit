...
create index if not exists commerce_dispute_webhook_events_dispute_idx on public.commerce_dispute_webhook_events(organization_id, connection_id, provider_dispute_id, observed_at desc);
create index if not exists commerce_provider_disputes_transaction_idx on public.commerce_provider_disputes(organization_id, connection_id, provider_transaction_id);
create index if not exists commerce_provider_dispute_lifecycle_idx on public.commerce_provider_dispute_lifecycle_events(dispute_id, observed_at desc);
