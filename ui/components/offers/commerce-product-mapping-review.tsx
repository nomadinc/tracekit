...
const priceEvidenceLabel = (prices: number[]) => prices.length > 1 ? `Observed prices: ${prices.map((price) => money.format(price)).join(", ")}` : prices.length === 1 ? `Product price: ${money.format(prices[0])}` : "Product price: unavailable";
