...
export type ConnectionExperience = SafeConnectionSummary & { credential: SafeCredentialHealth; readiness: SafeReadinessGate[]; productionReadiness:SafeProductionReadiness; diagnostics: SafeDiagnostics; freshness:SafeContinuousFreshness; syncRuns: SafeSyncRun[]; canManage: boolean };
