...
export type ConnectionExperience = SafeConnectionSummary & { credential: SafeCredentialHealth; readiness: SafeReadinessGate[]; diagnostics: SafeDiagnostics; freshness:SafeContinuousFreshness; syncRuns: SafeSyncRun[]; canManage: boolean };
