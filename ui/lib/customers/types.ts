...
export type CustomerRelatedOrder = { id:string; number:string; date:string; amount:number; profit:number|null; profitStatus:"Estimated"|"Reconciled"; profitAvailable?:boolean; status:string; refunded:boolean; offerId:string; offerName:string; trackingHealth:CustomerTrackingState; trackingEvidence?: { tkid:string|null; everflowTransactionId:string|null; transactionId:string|null; affiliateId:string|null; sourceId:string|null; sub1:string|null; sub2:string|null; sub3:string|null; sub4:string|null; sub5:string|null } };
